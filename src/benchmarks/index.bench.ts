...
new Benchmark.Suite('index.bench.ts')
    ...
    .add(fixedWidth('baseAddress (netparser orig)', 30), () => {
        npOrig.baseAddress('192.168.0.4/24');
    })
    ...
    .add(fixedWidth('contains (netparser orig)', 30), () => {
        npOrig.networkContainsAddress('192.168.0.0/24', '192.168.0.4');
    })
